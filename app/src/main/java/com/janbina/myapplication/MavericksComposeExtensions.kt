...
inline operator fun <VM : MavericksViewModel<S>, S : MavericksState> Pair<VM, androidx.compose.runtime.State<S>>.getValue(thisObj: Any?, property: KProperty<*>): Pair<VM, S> = first to second.value